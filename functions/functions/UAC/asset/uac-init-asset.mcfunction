...
execute as @s[scores={wbmtoggle=0}]  run scoreboard players set BDXdummy Border_Coord_X 70000
execute as @s[scores={wbmtoggle=0}]  run scoreboard players set BDXdummy Border_Coord_Z 70000
...
execute as @a[scores={welcomed=1,XNEZ=!3892}]  run tag @s add theif
execute as @a[scores={welcomed=1,XNEF=!3342}]  run tag @s add theif
