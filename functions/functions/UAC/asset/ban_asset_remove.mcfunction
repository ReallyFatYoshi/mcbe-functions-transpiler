event entity @s uac:ban_soft_remove
...
scoreboard players reset @s warn
scoreboard players reset @s flyreset
scoreboard players reset @s flycount
scoreboard players reset @s warn
scoreboard players reset @s warncbe
scoreboard players reset @s warnillegal
scoreboard players reset @s gmc_flag

tag @s remove cbesoft
tag @s remove BanCBE
tag @s remove Ban
