...
execute as @a[m=c,tag=!staffstatus]  run function UAC/asset/creative_flag_asset
...
execute as @s[tag=!staffstatus]  run execute @s[tag=BanCBE] ~~~ function UAC/asset/ban_asset
execute as @s[tag=!staffstatus]  run execute @s[tag=BanCreative] ~~~ function UAC/asset/ban_asset
execute as @s[tag=!staffstatus]  run execute @s[tag=Ban] ~~~ function UAC/asset/ban_asset
execute as @s[tag=!staffstatus]  run execute @s[tag=illegalitemban] ~~~ function UAC/asset/ban_asset
execute as @s[tag=!staffstatus]  run execute @s[tag=BanFly] ~~~ function UAC/asset/ban_asset
execute as @s[tag=!staffstatus]  run execute @s[tag=BanPhase] ~~~ function UAC/asset/ban_asset
execute as @s[tag=!staffstatus]  run execute @s[scores={warn=3}] ~~~ function UAC/asset/ban_asset
execute as @s[tag=!staffstatus,scores={Ban=1}]  run tag @s add Ban
