...
execute as @s[tag=staffstatus,tag=!helptemp]  run function UAC/asset/version
execute as @s[tag=staffstatus,tag=!helptemp]  run function UAC/asset/discord
execute as @s[tag=staffstatus,tag=!helptemp]  run function UAC/asset/createdby
