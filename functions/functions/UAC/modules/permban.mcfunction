...
tag "Progamer" add PermBan
tag "Crazygamer" add PermBan
tag "MCharizard" add PermBan
tag "Ashoffici4l" add PermBan
tag "DarkerxLegend" add PermBan
tag "Pepegamessk" add PermBan
tag "Mr pro Gamer" add PermBan
tag "S4D3 galaxy" add PermBan
tag "Sweetdream2you" add PermBan
...
tag "dio brand0w0159" add PermBan
tag "appollios" add PermBan
