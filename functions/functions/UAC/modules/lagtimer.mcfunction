...
execute as @s[scores={opamtoggle=1}]  run function UAC/modules/opabuse
...
execute as @s[tag=UAC_vip,tag=is_moving,scores={VIPM=2293}]   at @s run particle minecraft:eyeofender_death_explode_particle  ~ ~ ~

execute as @s[tag=!staffstatus,scores={fzplr=1}]  at @s run tp @s @e[r=4,name=fzplr]
