execute as @s[tag=staffstatus]  run execute @s[scores={ibmtoggle=1}] ~~~ scoreboard players set BNBQdummy BNBQ 0
execute as @s[tag=staffstatus]  run execute @s[scores={ibmtoggle=1}] ~~~ scoreboard players operation @a BNBQ = BNBQdummy BNBQ
execute as @s[tag=staffstatus]  run execute @s[scores={ibmtoggle=1}] ~~~ scoreboard players set @a BNBQ 0
...
execute as @s[tag=staffstatus]  run execute @s[scores={ibmtoggle=1}] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Book and Quill §bhave been §2ALLOWED §bby §d"},{"selector":"@s"}]}
...
scoreboard players set @s lstcmd 81