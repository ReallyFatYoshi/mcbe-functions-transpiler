...
execute as @s[tag=staffstatus]  run tellraw @s {"rawtext":[{"text":"§¶§cUAC §¶§b► §bdiamond Kit has been applied to §d"},{"selector":"@s"}]}
execute as @a[tag=staffstatus]  run playsound note.pling @s ~ ~ ~
