...
execute as @s[tag=staffstatus]  run tellraw @s {"rawtext":[{"text":"§¶§cUAC §¶§b► §bIron Kit has been applied to §d"},{"selector":"@s"}]}
...
replaceitem entity @s[tag=staffstatus] slot.armor.legs 0 iron_leggings 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=staffstatus] slot.armor.feet 0 iron_boots 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=staffstatus] slot.weapon.offhand 0 totem_of_undying 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=staffstatus] slot.weapon.mainhand 0 iron_sword 1 0 {"minecraft:keep_on_death":{}}
